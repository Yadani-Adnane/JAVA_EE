...
<form action="UpdateResiServlet?btn=save&resi=loc&id=${param.id}" method="post">
            ...
            <input type="radio" id="male" ${param.genre == 'M' ? 'checked' : ''} name="genre" value="M" required>
            <label for="male">Male</label><br>
            <input type="radio" id="female" ${param.genre == 'F' ? 'checked' : ''} name="genre" value="F" required>
            ...
            <input type="text" id="telGarant" value="${param.telGarant}" name="telGarant" required><br><br>
            ...
            <input type="text" id="reservationNonPayees" value="${param.reservationNonPayees}" name="reservationNonPayees" required><br><br>

            <label for="CNE">CNE:</label>
            <input type="text" id="CNE" name="CNE" value="${param.cne}" required><br><br>

            <label for="cin">CIN:</label>
            <input type="text" id="cin" name="cin" value="${param.cin}" required><br><br>
